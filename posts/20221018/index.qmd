...
Questo è stato il **peggiore** allenamento fatto finora.
...
x %>% 
    filter(date == lubridate::ymd("2022-10-18")) %>%
...
1. [Battuta-Ricezione-Attacco](https://youtu.be/peaALm_LihY)
2. [Partita](https://youtu.be/yoHtvFL-h4w)
