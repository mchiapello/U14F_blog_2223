---
title: "Sessantottesimo Allenamento"
...
x2 %>%
    ...
    filter(mese == lubridate::month(quarto::quarto_inspect(fs::dir_ls(".", regex = "qmd$"))$formats$html$metadata$date)) %>% 
