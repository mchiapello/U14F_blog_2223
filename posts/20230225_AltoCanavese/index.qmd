---
title: "BCV Foglizzo - Alto Canavese Volley"
...
# Read data
file <- fs::dir_ls("~/Documents/personale/PALLAVOLO/U14F_blog_2223/data/002_Partite/2023-02-25_Alto Canavese/", 
                   regexp = "dvw$")
x <- dv_read(file)
noi <- teams(x)[1]
...
df <- tribble(
    ...
    "Contenimento degli errori", 0.7,
    "Abilità degli avversari", 0.1,
...
{{< video https://www.youtube.com/embed/3s3uj1OQS0w >}}
