---
title: "Quindicesino Allenamento"
...
x %>% 
    filter(date == lubridate::ymd("2022-10-05")) %>%
...
Marta presente ma non si è allenata per infortuneo.
...
Ancora nessun dato per questo mese.
