---
title: "Amichevole BCV Foglizzo - Samone"
...
# Read data
file <- fs::dir_ls(paste0(here::here(), "/data/002_Partite/2022-11-08_Samone"), 
                   regexp = "dvw$")
x <- dv_read(file)
noi <- teams(x)[1]
...
Avremmo potuto  fare molto meglio, ci siamo abbassati al loro gioco invece di riuscire ad imporre il nostro!    
Comunque molto soddisfatti della vittoria **schiacciante**.
...
1. [Partita](https://youtu.be/739D-587_q0)

{{< video https://www.youtube.com/embed/739D-587_q0 >}}
