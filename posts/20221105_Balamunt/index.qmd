---
title: "Balamunt - Basso Canavese Foglizzo"
...
# Read data
file <- fs::dir_ls(paste0(here::here(), "/data/002_Partite/2022-11-05_Balamunt/"), 
                   regexp = "dvw$")
x <- dv_read(file)
noi <- teams(x)[1]
...
df <- tribble(
    ~variable, ~percentage,
    "Gioco di squadra", 0.5,
    "Contenimento degli errori", 0.3,
    "Abilità degli avversari", 0.9,
    "Soddisfazione\ndegli allenatori", 0.5,
    "Voto", 0.5)
...
1. [Partita](https://youtu.be/hNXqbeEJ9rg)
